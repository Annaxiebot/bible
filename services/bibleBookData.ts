...
export const BIBLE_BOOKS: Book[] = [
  ...
  { name: '约珥书 Joel', id: 'JOL', chapters: 3 },
  { name: '阿摩司书 Amos', id: 'AMO', chapters: 9 },
  { name: '俄巴底亚书 Obadiah', id: 'OBA', chapters: 1, totalVerses: 21 },
  ...
  { name: '腓利门书 Philemon', id: 'PHM', chapters: 1, totalVerses: 25 },
  ...
  { name: '约翰二书 2 John', id: '2JN', chapters: 1, totalVerses: 13 },
  { name: '约翰三书 3 John', id: '3JN', chapters: 1, totalVerses: 14 },
  { name: '犹大书 Jude', id: 'JUD', chapters: 1, totalVerses: 25 },
