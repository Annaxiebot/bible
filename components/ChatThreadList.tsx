          ...
          <div key={group.label}>
            ...
            {group.threads.map((t) => (
              <div
                ...
                className={`group/thread relative mx-2 mb-0.5 px-3 py-2 rounded-lg cursor-pointer text-sm ${
                  t.id === activeThreadId
              ...
              >
                ...
                {confirmDelete === t.id ? (
                  ...
                  <button
                    ...
                    onTouchEnd={(e) => { e.stopPropagation(); e.preventDefault(); setConfirmDelete(t.id); }}
                    className="absolute right-2 top-1/2 -translate-y-1/2 opacity-60 sm:opacity-0 sm:group-hover/thread:opacity-100 transition-opacity p-1 rounded hover:bg-red-50 text-slate-400 hover:text-red-500"
                  >
