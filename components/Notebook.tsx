...
const Notebook: React.FC<NotebookProps> = ({ selection, onSaveNote, initialContent }) => {
  ...
  const flushSave = () => {
    if (isDirtyRef.current && currentIdRef.current && selection) {
          ...
          {!selection ? (
            <div className="flex-1 flex items-center justify-center p-6">
              <div className="text-center text-slate-400">
                ...
                <p className="text-lg font-medium mb-2">请先选择经文</p>
                <p className="text-sm">Select a Bible verse to start taking notes</p>
              </div>
            </div>
          ) : (
            <div 
